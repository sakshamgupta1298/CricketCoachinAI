...
def check_backend_status():
    ...
    try:
        response = requests.get('http://165.232.184.91:3000/api/health', timeout=10)
    ...
    try:
        ...
        response = requests.post('http://165.232.184.91:3000/api/auth/register', 
        ...
        response = requests.post('http://165.232.184.91:3000/api/auth/login', 
