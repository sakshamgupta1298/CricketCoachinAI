...
const testEndpoints = [
  'https://165.232.184.91:3000/api/health', // Digital Ocean droplet
  'https://192.168.1.11:3000/api/health', // Current system IP
  'https://192.168.1.3:3000/api/health',  // Old IP (for reference)
  'https://localhost:3000/api/health'     // Localhost
];
...
async function testConnectivity() {
  ...
  console.log('\n📱 For your mobile app:');
  console.log('   - Use the Digital Ocean droplet: https://165.232.184.91:3000');
