...
echo "  - Backend URL: http://165.232.184.91:3000"
echo "  - Nginx Proxy: http://165.232.184.91"
echo "  - Health Check: http://165.232.184.91/health"
echo ""
...
echo "  - Test Backend: curl http://165.232.184.91/health"
echo ""
print_warning "Next Steps:"
echo "  1. Update your mobile app config to use: http://165.232.184.91"
