        ...
        >
          ...
          <Animated.View entering={FadeInUp.delay(500).springify()}>
            <PremiumCard variant="elevated" padding="large" style={styles.authCard}>
              ...
              {/* Timer */}
              {!canResend && timer > 0 && (
                <Text style={[styles.timerText, { color: theme.colors.onSurfaceVariant, fontSize: getResponsiveFontSize(12) }]}>
              ...
              {canResend && (
                <TouchableOpacity 
                  ...
                  activeOpacity={0.7}
                >
                  <Text style={[styles.resendText, { color: theme.colors.primary, fontSize: getResponsiveFontSize(14) }]}>
                    Resend OTP
                  </Text>
                </TouchableOpacity>
              )}
