...
export default function BallSpeedScreen() {
  ...
  const computeFromFrames = useCallback(
    (release: number, arrival: number) => {
      const fps = getFps();
  ...
  const deltaFrames =
    releaseFrame != null && arrivalFrame != null ? Math.max(0, arrivalFrame - releaseFrame) : null;
          ...
          <PremiumCard variant="elevated" padding="large" style={styles.cameraCard}>
            <View style={styles.cameraHeader}>
              <View style={styles.controlsRow}>
                ...
                >
                  <Text
                    style={[styles.resetButtonText, { color: 'white', fontSize: getResponsiveFontSize(14) }]}
                  >
                    Record
                  </Text>
                </TouchableOpacity>
              ...
              <View style={styles.scrubPanel}>
                ...
                <View style={styles.rateRow}>
                  ...
                  >
                    <Text
                      style={[
                        ...
                        { color: playbackRate === 1 ? 'white' : theme.colors.onSurface },
                      ]}
                    >
                      1x
                    </Text>
                  ...
                  >
                    <Text
                      style={[
                        styles.smallButtonText,
                        { color: playbackRate === 0.5 ? 'white' : theme.colors.onSurface },
                      ]}
                    >
                      0.5x
                    </Text>
                  ...
                  >
                    <Text
                      style={[
                        styles.smallButtonText,
                        { color: playbackRate === 0.25 ? 'white' : theme.colors.onSurface },
                      ]}
                    >
                      0.25x
                    </Text>
                ...
                <View style={styles.marksMeta}>
                  <View style={styles.markMetaCol}>
                    ...
                    <Text style={[styles.inlineMetaValue, { color: theme.colors.onSurface }]}>
                      {releaseFrame != null && releaseSec != null
                        ? `f${releaseFrame} (${releaseSec.toFixed(3)}s)`
                        : '—'}
                    </Text>
                  </View>
                  <View style={styles.markMetaCol}>
                    ...
                    <Text style={[styles.inlineMetaValue, { color: theme.colors.onSurface }]}>
                      {arrivalFrame != null && arrivalSec != null
                        ? `f${arrivalFrame} (${arrivalSec.toFixed(3)}s)`
                        : '—'}
                    </Text>
                  </View>
                </View>
