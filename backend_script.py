...
# # OpenAI client
# client = OpenAI(api_key="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")
...
#         return {"error": "Failed to read CSV file", "details": str(e)}
...
#         try:
#             # Try to parse directly first (since we're using json_object format)
...
#         import traceback
#         traceback.print_exc()
#         return {"error": "Failed to generate GPT feedback", "details": str(e)}
...
#                     if isinstance(gpt_feedback, dict) and "error" in gpt_feedback:
#                         print(f"GPT feedback error: {gpt_feedback.get('error')}")
#                         print(f"Error details: {gpt_feedback.get('details', 'No details')}")
#                 except Exception as e:
#                     print(f"Error in GPT feedback: {str(e)}")
#                     import traceback
#                     traceback.print_exc()
#                     gpt_feedback = {"error": "Unable to generate feedback at this time.", "details": str(e)}
